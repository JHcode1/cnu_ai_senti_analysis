...
#############################################
# - 2022.10.18 파일 생성, 박재희
# - 2022.10.25 파일 수정, 박재희
#############################################

# 함수 생성
# - 함수 : 반복적으로 사용하는 기능을 코드로 묶어서 만듬
# - 사용 : 함수 이름으로 호출
# - Python에서 () 붙어있으면 대부분 함수
# - ex) print(), pprint(), get(), get_text()
# - 내장 함수 : 파이썬 설치하면 기본적으로 제공
# - 외부 함수 : 다른 개발자가 만들어 놓은것 import 해서 사용
